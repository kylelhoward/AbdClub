...
public class SeedModel : PageModel
{
    ...
    public async Task<IActionResult> OnPostSeedMembersAsync()
    {
        ...
        {
            // Active members
            new() { LastName = "Alice Johnson",   Email = "alice.johnson.test@gmail.com",
                    JoinDate = today, ExpiryDate = today.AddYears(1)
                },
            new() { LastName = "Bob Martinez",    Email = "bob.martinez.test@gmail.com",
                    JoinDate = today, ExpiryDate = today.AddMonths(8)},
            new() { LastName = "Carol Williams",  Email = "carol.williams.test@gmail.com",
                    JoinDate = today, ExpiryDate = today.AddMonths(6) },

            // Expiring soon
            new() { LastName = "David Chen",      Email = "david.chen.test@gmail.com",
                    JoinDate = today, ExpiryDate = today.AddDays(55) },
            new() { LastName = "Eve Thompson",    Email = "eve.thompson.test@gmail.com",
                    JoinDate = today, ExpiryDate = today.AddDays(28) },
            new() { LastName = "Frank Garcia",    Email = "frank.garcia.test@gmail.com",
                    JoinDate = today, ExpiryDate = today.AddDays(5) },

            // Expired
            new() { LastName = "Grace Lee",       Email = "grace.lee.test@gmail.com",
                    JoinDate = today.AddYears(-1), ExpiryDate = today.AddDays(-10) },
            new() { LastName = "Henry Wilson",    Email = "henry.wilson.test@gmail.com",
